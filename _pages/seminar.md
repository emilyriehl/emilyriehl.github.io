...
Abstract: The title is already the abstract, but in particular: I’ll introduce homotopy type theory, a logical framework which, on the one hand:
...
and examine both extrinsic and *intrinsic* descriptions of when a
...
twofold: 
    - First, the nature of this internalisation is such that it makes both expedient and clear arguments which would otherwise be phrased
  ...
  utility to the mathematician working in a topos. 
    - Second, this reinterpretation bears interesting and non-trivial
