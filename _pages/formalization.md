...
* For a first-year seminar course on computer-verified proof taught in Fall 2025, I built a [Reintroduction to Proofs](https://adam.math.hhu.de/#/g/emilyriehl/ReintroductionToProofs) Lean game that introduces informal dependent type theory at the level of an introduction to proofs course. This can now be found on the [Lean Game Server](https://adam.math.hhu.de/).
...
* A project to formalize formal &infin;-category theory in Lean was launched in Fall 2024. A [blueprint](https://emilyriehl.github.io/infinity-cosmos/) set up for me by [Pietro Monticone](https://github.com/pitmonticone) describes our broader objectives and initial formalization targets. This project is co-lead by [Dominic Verity](https://dom-verity.github.io/) and [Mario Carneiro](https://digama0.github.io/) who collaborated with me on the surprisingly intricate task to construct the left adjoint to the nerve functor, described in a paper [Formalizing colimits in Cat](https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.ITP.2025.20).
